const listContents = [
    ...
    {
        id: 4,
        img: "https://res.cloudinary.com/duy-hiep/image/upload/v1654625747/asm-web-2022/Rectangle_40_xoxaqu.png",
        title: "Components",
        year: 2018,
...
function showContents(contents){
    ...
    for(let i = 0; i < contents.length; i++){
        ...
        <div class="mx-4 mt-6">
          ...
          <div>
          <div class="mt-3 mx-4">
            <a href="content(work).html"><h3 class="font-bold text-[24px]">${content.title}</h3></a>
            <div class="mt-4">
